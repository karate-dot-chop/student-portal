<template>
  <div class="about">
    <div>
      ...
      <router-link :to="`/students/${current_user.id}/edit`"
    ...
    <div>
      ...
      <div v-for="education in educations" v-bind:key="education.id">
        ...
        <router-link :to="`/educations/${current_user.id}/edit`"
          >Edit Education</router-link
        >
        <!--Needs soft-coded :id later-->
      </div>
    </div>
    <div>
      ...
      <div v-for="experience in experiences" v-bind:key="experience.id">
        ...
        <router-link :to="`/experiences/${current_user.id}/edit`"
    ...
    <div>
      ...
      <div v-for="capstone in capstones" v-bind:key="capstone.id">
        ...
        <router-link :to="`/capstones/${current_user.id}/edit`"
...
export default {
  ...
  created: function () {
    axios.get(`/students/${current_user.id}`).then((response) => {
      console.log("User ? : ", current_user.id);
